...
--
-- Host: mysqldb
-- Gegenereerd op: 23 dec 2020 om 15:35
-- Serverversie: 5.7.32
-- PHP-versie: 7.4.11
...
--
CREATE DATABASE IF NOT EXISTS `ticketswapper` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ticketswapper`;
...
(14, 'Rock am Ring & Rock im Park', 225.00, '2021-06-11 21:52:00', '2021-06-13 21:52:00', 'Mendig en Neurenberg, Duitsland', 'Als rock en heavy metal in jouw ding is, dan heeft Duitslands Rock am Ring geen introductie nodig. Samen met zusterfestival Rock im Park, weet het jaar na jaar ongeëvenaarde line-ups te presenteren en heeft het zichzelf bevestigd als een van de best bezochte weekenden ter wereld.', 'System of a Down, Green Day, Volbeat, Deftones, Billy Talent, Korn, Weezer, Broilers', 'rockamring&rockimpark'),
...
INSERT INTO `users` (`gebruiker_id`, `first_name`, `last_name`, `address`, `couponcode`, `invite_number`, `email`, `password`, `discount_amount`) VALUES
(1, 'Louis', 'D\'Hont', 'Dorp 71A, Oosterzele', 'sD4oFcma9c', '0', 'louis.dhont@student.odisee.be', '$2y$10$qpMTkVbvc6E.4dt2uk9BlOOadOXiz3J5tqiBwtcmWMupGiX5GiO/q', 0),
(2, 'Joris', 'Maervoet', 'Gebroeders de Smetstraat 1, 9000 Gent', 'fo2qmt17xr', '0', 'joris.maervoet@odisee.be', '$2y$10$qpMTkVbvc6E.4dt2uk9BlOOadOXiz3J5tqiBwtcmWMupGiX5GiO/q', 0),
(3, 'Timon', 'De Bruyne', 'randomStraat 9, 9000 Gent', 'f2TIKVJ2KP', '0', 'timon.debruyne@student.odisee.be', '$2y$10$KqrUuDwLRFHEBX/Ul2wEMOthuLZqRYa0cL0xhYaLcknux7jNAETxO', 0);
